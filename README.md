...
## Evidencias
Capturas del escenario y el workflow adjuntas en el drive

## Seguridad 
Anonimizados y modificados en el JSON el correo del destinatario, el nombre de la conexión de Gmail/Google y el ID/ruta del spreadsheet.
